...
<div class='webaudio-slider-body touch-action='none'><div class='webaudio-slider-knob' touch-action='none' tabindex='1'></div><div class='webaudioctrl-tooltip'></div><div part="label" class="webaudioctrl-label"><slot></slot></div></div>
`;
      this.elem=root.childNodes[2];
